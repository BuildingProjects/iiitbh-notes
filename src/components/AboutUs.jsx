...
import animation from "../assets/about.json";
import animation2 from "../assets/aboutImage.json";
import Lottie from "lottie-react";

function AboutUs() {
  return (
    <div>
      <section class='py-14 lg:pt-[0.5rem] lg:pb-24 relative'>
        <div class='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative '>
          <div class='grid grid-cols-1 lg:grid-cols-2 gap-9'>
            <div class='img-box mt-[5.5rem] lg:ml-[-100px]'>
              {/* <img src="https://pagedone.io/asset/uploads/1702034769.png" alt="About Us tailwind page"
                        class="max-lg:mx-auto" /> */}
              <Lottie
                loop={true}
                animationData={animation2}
                class='max-lg:mx-auto lg:w-[118%] sm:w-[100%]'
              />
            </div>
            <div class='lg:pl-[100px] flex items-center'>
              <div class='data w-full'>
                ...
                <Lottie
                  ...
                  class='relative mb-9 sm:w-[60%] lg:w-[100%]'
                />
                <p class='font-normal text-xl leading-8 text-gray-500 max-lg:text-center max-w-2xl mx-auto'>
                  At IIITBH NOTES, we understand the challenges of academic life
                  and coding journeys. That's why we've curated a comprehensive
                  collection of downloadable notes, PYQs, and textbooks across
                  various subjects. But that's not all – we believe in
                  collaboration! You can contribute to our community by
                  uploading your own notes, helping others just as they help
                  you. Together, we can build a repository of knowledge that
                  benefits everyone
                </p>
              </div>
            </div>
      ...
      <section class='bg-white'>
        <div class='py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 '>
          <div class='mx-auto max-w-screen-sm text-center mb-8 lg:mb-16'>
            <h2 class='mb-4 text-7xl tracking-tight font-extrabold text-[#6366F1]'>
              Our Team
            </h2>
            <p class='font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400'>
              Meet the Developers and Creators of this Website.
            </p>
          </div>
          <div class='grid gap-8 mb-6 lg:mb-16 md:grid-cols-2'>
            <div class='items-center bg-indigo-500 rounded-lg shadow sm:flex '>
              <a href='#'>
                <img
              ...
              <div class='p-5'>
                <h3 class='text-2xl font-bold tracking-tight text-white'>
                  <a href='#'>Ankur Dwivedi</a>
                </h3>
                <span class='text-gray-50'>Full Stack Developer</span>
                <p class='mt-3 mb-4 font-light text-gray-50'>
                  Created this website from scratch enabling users to download
                  notes.
                </p>
                <ul class='flex space-x-4 sm:mt-0'>
                  <li>
                    <a
                      href='https://www.linkedin.com/in/ankur-dwivedi005/'
                  ...
                  <li>
                    <a
                      href='https://www.instagram.com/ankurdwivedi244/'
                      class='text-white hover:text-gray-500'
                      target='_blank'
                    >
                      <svg
            ...
            <div class='items-center bg-indigo-500 rounded-lg shadow sm:flex '>
              ...
              <div class='p-5'>
                ...
                <ul class='flex space-x-4 sm:mt-0'>
                  ...
                  <li>
                    <a
                      href='https://github.com/Roshu2003'
                      class='text-white hover:text-gray-500'
                      target='_blank'
                    >
                      <svg
                  ...
                  <li>
                    <a
                      href='https://www.instagram.com/roshan.029?utm_source=qr&igsh=MTB0Y2Z1ZnphMXRscg=='
                      class='text-white hover:text-gray-500'
                      target='_blank'
                    >
                      <svg
