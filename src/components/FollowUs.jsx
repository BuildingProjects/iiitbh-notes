...
const FollowUs = () => {
  return (
    <div className='container mx-auto p-4'>
      <h2 className='text-7xl text-[#6366F1] font-bold mb-4 text-center'>
        Follow Us
      </h2>
      <div className='flex flex-wrap justify-center'>
        ...
        <div className='w-full md:w-1/3 xl:w-1/3 p-4'>
          <div className='bg-white rounded shadow-md p-4'>
            ...
            <p className='text-gray-600 mb-4'>
              Connect with us on LinkedIn for industry insights and company
              updates!
            </p>
            <a
        ...
        <div className='w-full md:w-1/3 xl:w-1/3 p-4'>
          <div className='bg-white rounded shadow-md p-4'>
            ...
            <p className='text-gray-600 mb-4'>
              Stay up-to-date with our latest Telegram and join the
              conversation!
            </p>
            <a
