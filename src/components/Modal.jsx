            ...
            <div className="flex flex-col justify-center items-center">
              ...
              <div className="flex flex-col gap-5">
                <button
                  ...
                  value="CSE"
                  type="button"
                  className="text-black bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-xl px-5 py-2.5 me-2 mb-2 w-[15.5rem]"
                >
                  CSE
                </button>
                <button
